...
```{r}
# sparsity measures of the datasets - raw counts and smoothed data
sparsity_counts <- readRDS("./data_outputs/realDataOut/sparsity_counts.Rds")
sparsity_smoothed <- readRDS("./data_outputs/realDataOut/sparsity_smoothed.Rds")

sparsity_plot <- 
  left_join(sparsity_counts, sparsity_smoothed, by = "Technology") %>%
  select(Technology, Percent_NonZero_counts, Percent_NonZero_smoothed) %>%
  pivot_longer(cols = c(Percent_NonZero_counts, Percent_NonZero_smoothed), 
               names_to = "Datatype", values_to = "Percent_NonZero") %>%
  mutate(Datatype = 
           recode(Datatype, 
                  "Percent_NonZero_counts" = "Measured expression",
                  "Percent_NonZero_smoothed" = "Smoothed expression"),
         Technology = factor(Technology, 
                             levels = c("Stere-seq", "VisiumHD", "CosMx",
                                        "Xenium", "SeqFISH", "MERFISH"))) %>%
  ggplot(aes(x = Technology, y = Percent_NonZero, group = Datatype, fill = Datatype)) +
  geom_col(position = "dodge") +
  # facet_wrap(~Datatype, nrow = 1) +
  labs(x = "", y = "Non-zero expression (%)") +
  scale_fill_manual(values = c("Measured expression" = "#3d405b",
                                "Smoothed expression" = "#e07a5f")) +
  theme_classic() +
...
ggsave("./data_outputs/visuals/Suppl_sparsity.pdf", sparsity_plot, width = 5, 
       height = 6, units = "in")
```
...
```{r}
# color panel
colors <- setNames(c("#8EC792", "#635547", "#EF5A9D", "#0F4A9C", "#3F84AA", 
                     "#DFCDE4", "#ff891c", "#C594BF", "#65A83E", "#FACB12", 
                     "#139992", "#9e6762", "#005579", "#8DB5CE", "#C72228", 
...
clustDF_lc$Sample <- factor(clustDF_lc$Sample, 
                            levels = c("Lung5_Rep1", "Lung5_Rep2", "Lung5_Rep3",
...
me_cSIGNAL <- ggplot(clustDF_me, aes(x = x, y = -y, color = ClustSIGNAL)) +
  ...
  facet_wrap(~Sample, scales = "free", 
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "ME", ],
                                           "ClustSIGNAL_ari"))) +
  ...
  theme(axis.text = element_blank(),
        ...
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_ME_cSIGNALplots_v2.pdf", plot = me_cSIGNAL, 
...
br_cSIGNAL <- ggplot(clustDF_br, aes(x = x, y = -y, color = ClustSIGNAL)) +
  ...
  facet_wrap(~Sample, scales = "free", ncol = 1, 
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "BR", ],
                                           "ClustSIGNAL_ari"))) +
  scale_color_manual(values = colors) +
  guides(colour = guide_legend(override.aes = list(size = 5))) +
  labs(color = "ClustSIGNAL") +
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_BR_cSIGNALplots_v2.pdf", plot = br_cSIGNAL, 
...
lc_cSIGNAL <- ggplot(clustDF_lc, aes(x = x, y = -y, color = ClustSIGNAL)) +
  ...
  facet_wrap(~Sample, scales = "free", ncol = 3,
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "LC", ],
                                           "ClustSIGNAL_ari"))) +
  scale_color_manual(values = colors) +
  guides(colour = guide_legend(override.aes = list(size = 5))) +
  labs(color = "ClustSIGNAL") +
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_LC_cSIGNALplots_v2.pdf", plot = lc_cSIGNAL, 
...
mh_cSIGNAL <- ggplot(clustDF_mh, aes(x = x, y = -y, color = ClustSIGNAL)) +
  ...
  facet_wrap(~Sample, scales = "free", ncol = 12, 
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "MH", ],
                                           "ClustSIGNAL_ari"))) +
  scale_color_manual(values = colors) +
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_MH_cSIGNALplots_v2.pdf", plot = mh_cSIGNAL, 
       width = 17, height = 19, units = "in")


#### SteroSeq ovarian cancer

oc_cSIGNAL <- ggplot(clustDF_oc, aes(x = x, y = -y, color = ClustSIGNAL)) +
  geom_scattermore(pointsize = 1) +
  facet_wrap(~Sample, scales = "free",
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "OC", ],
                                           "ClustSIGNAL_ari"))) +
  scale_color_manual(values = colors) +
  guides(colour = guide_legend(override.aes = list(size = 5), ncol = 1)) +
  labs(color = "ClustSIGNAL") +
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_OC_cSIGNALplots.pdf", plot = oc_cSIGNAL, 
       width = 7, height = 7, units = "in")


#### VisiumHD colon cancer

coad_cSIGNAL <- ggplot(clustDF_coad, aes(x = x, y = -y, color = ClustSIGNAL)) +
  geom_scattermore(pointsize = 1) +
  facet_wrap(~Sample, scales = "free",
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "COAD", ],
                                           "ClustSIGNAL_ari"))) +
  scale_color_manual(values = colors) +
  guides(colour = guide_legend(override.aes = list(size = 5), ncol = 1)) +
  labs(color = "ClustSIGNAL") +
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_COAD_cSIGNALplots.pdf", plot = coad_cSIGNAL, 
       width = 10, height = 8, units = "in")
```
...
me_banksy <- ggplot(clustDF_me, aes(x = x, y = -y, color = BANKSY)) +
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_ME_Banksyplots_v2.pdf", plot = me_banksy, 
...
br_banksy <- ggplot(clustDF_br, aes(x = x, y = -y, color = BANKSY)) +
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_BR_Banksyplots_v2.pdf", plot = br_banksy, 
       width = 7, height = 8, units = "in")
...
lc_banksy <- ggplot(clustDF_lc, aes(x = x, y = -y, color = BANKSY)) +
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_LC_Banksyplots_v2.pdf", plot = lc_banksy, 
       width = 10, height = 8, units = "in")
...
mh_banksy <- ggplot(clustDF_mh, aes(x = x, y = -y, color = BANKSY)) +
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_MH_Banksyplots_v2.pdf", plot = mh_banksy, 
       width = 17, height = 19, units = "in")


#### SteroSeq ovarian cancer

oc_banksy <- ggplot(clustDF_oc, aes(x = x, y = -y, color = BANKSY)) +
  geom_scattermore(pointsize = 1) +
  facet_wrap(~Sample, scales = "free",
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "OC", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_OC_Banksyplots.pdf", plot = oc_banksy, 
       width = 7, height = 7, units = "in")


#### VisiumHD colon cancer

coad_banksy <- ggplot(clustDF_coad, aes(x = x, y = -y, color = BANKSY)) +
  geom_scattermore(pointsize = 1) +
  facet_wrap(~Sample, scales = "free",
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "COAD", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_COAD_Banksyplots.pdf", plot = coad_banksy, 
       width = 10, height = 8, units = "in")
```
...
me_bass <- ggplot(clustDF_me, aes(x = x, y = -y, color = BASS)) +
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_ME_BASSplots_v2.pdf", plot = me_bass, 
       width = 8.5, height = 4, units = "in")


#### Xenium breast cancer

br_bass <- ggplot(clustDF_br, aes(x = x, y = -y, color = BASS)) +
  geom_scattermore(pointsize = 1.5) +
  facet_wrap(~Sample, scales = "free", ncol = 1, 
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "BR", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_BR_BASSplots.pdf", plot = br_bass, 
       width = 7, height = 8, units = "in")


#### CosMx lung cancer

lc_bass <- ggplot(clustDF_lc, aes(x = x, y = -y, color = BASS)) +
  geom_scattermore(pointsize = 1.5) +
  facet_wrap(~Sample, scales = "free", ncol = 3,
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "LC", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_LC_BASSplots.pdf", plot = lc_bass, 
       width = 10, height = 8, units = "in")
...
mh_bass <- ggplot(clustDF_mh, aes(x = x, y = -y, color = BASS)) +
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_MH_BASSplots_v2.pdf", plot = mh_bass, 
       width = 17, height = 19, units = "in")


#### SteroSeq ovarian cancer

oc_bass <- ggplot(clustDF_oc, aes(x = x, y = -y, color = BASS)) +
  geom_scattermore(pointsize = 1) +
  facet_wrap(~Sample, scales = "free",
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "OC", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_OC_BASSplots.pdf", plot = oc_bass, 
       width = 7, height = 7, units = "in")
```
...
me_sPCA <- ggplot(clustDF_me, aes(x = x, y = -y, color = SpatialPCA)) +
  geom_scattermore(pointsize = 2.5) +
  facet_wrap(~Sample, scales = "free",
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "ME", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_ME_sPCAplots_v2.pdf", plot = me_sPCA, 
       width = 8.7, height = 4, units = "in")


#### MERFISH mouse hypothalamus

mh_sPCA <- ggplot(clustDF_mh, aes(x = x, y = -y, color = SpatialPCA)) +
  geom_scattermore(pointsize = 4) +
  facet_wrap(~Sample, scales = "free", ncol = 12, 
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_MH_sPCAplots_v2.pdf", plot = mh_sPCA, 
       width = 17, height = 19, units = "in")
```
...
me_graphst <- ggplot(clustDF_me, aes(x = x, y = -y, color = GraphST)) +
  geom_scattermore(pointsize = 2.5) +
  facet_wrap(~Sample, scales = "free", 
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "ME", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_ME_GraphSTplots.pdf", plot = me_graphst, 
       width = 8.5, height = 4, units = "in")
```
...
me_spagcn <- ggplot(clustDF_me, aes(x = x, y = -y, color = SpaGCN)) +
  geom_scattermore(pointsize = 2.5) +
  facet_wrap(~Sample, scales = "free", 
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "ME", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_ME_SpaGCNplots.pdf", plot = me_spagcn, 
       width = 8.5, height = 4, units = "in")

#### Xenium breast cancer

br_spagcn <- ggplot(clustDF_br, aes(x = x, y = -y, color = SpaGCN)) +
  geom_scattermore(pointsize = 1.5) +
  facet_wrap(~Sample, scales = "free", ncol = 1, 
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "BR", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_BR_SpaGCNplots.pdf", plot = br_spagcn, 
       width = 7, height = 8, units = "in")


#### CosMx lung cancer

lc_spagcn <- ggplot(clustDF_lc, aes(x = x, y = -y, color = SpaGCN)) +
  geom_scattermore(pointsize = 1.5) +
  facet_wrap(~Sample, scales = "free", ncol = 3,
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "LC", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_LC_SpaGCNplots.pdf", plot = lc_spagcn, 
       width = 10, height = 8, units = "in")


#### MERFISH mouse hypothalamus

mh_spagcn <- ggplot(clustDF_mh, aes(x = x, y = -y, color = SpaGCN)) +
  geom_scattermore(pointsize = 4) +
  facet_wrap(~Sample, scales = "free", ncol = 12, 
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "MH", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_MH_SpaGCNplots.pdf", plot = mh_spagcn, 
       width = 17, height = 19, units = "in")
```
...
me_stagate <- ggplot(clustDF_me, aes(x = x, y = -y, color = STAGATE)) +
  geom_scattermore(pointsize = 2.5) +
  facet_wrap(~Sample, scales = "free", 
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "ME", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_ME_STAGATEplots.pdf", plot = me_stagate, 
       width = 10, height = 5, units = "in")


#### Xenium breast cancer

br_stagate <- ggplot(clustDF_br, aes(x = x, y = -y, color = STAGATE)) +
  geom_scattermore(pointsize = 1.5) +
  facet_wrap(~Sample, scales = "free", ncol = 1, 
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "BR", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_BR_STAGATEplots.pdf", plot = br_stagate, 
       width = 9, height = 9, units = "in")


#### CosMx lung cancer

lc_stagate <- ggplot(clustDF_lc, aes(x = x, y = -y, color = STAGATE)) +
  geom_scattermore(pointsize = 1.5) +
  facet_wrap(~Sample, scales = "free", ncol = 3,
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "LC", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_LC_STAGATEplots.pdf", plot = lc_stagate, 
       width = 10, height = 8, units = "in")


#### MERFISH mouse hypothalamus

mh_stagate <- ggplot(clustDF_mh, aes(x = x, y = -y, color = STAGATE)) +
  geom_scattermore(pointsize = 4) +
  facet_wrap(~Sample, scales = "free", ncol = 12, 
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "MH", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_MH_STAGATEplots.pdf", plot = mh_stagate, 
       width = 17, height = 19, units = "in")


#### SteroSeq ovarian cancer

oc_stagate <- ggplot(clustDF_oc, aes(x = x, y = -y, color = STAGATE)) +
  geom_scattermore(pointsize = 1) +
  facet_wrap(~Sample, scales = "free",
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "OC", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_OC_STAGATEplots.pdf", plot = oc_stagate, 
       width = 8, height = 7, units = "in")


#### VisiumHD colon cancer

coad_stagate <- ggplot(clustDF_coad, aes(x = x, y = -y, color = STAGATE)) +
  geom_scattermore(pointsize = 1) +
  facet_wrap(~Sample, scales = "free",
             labeller = 
               labeller(Sample = ari_label(metrics[metrics$Dataset == "COAD", ],
  ...
  theme(axis.text = element_blank(),
        ...
        legend.title = element_text(size = 14),
        legend.text = element_text(size = 12))
ggsave("./data_outputs/visuals/Bench_COAD_STAGATEplots.pdf", plot = coad_stagate, 
...
```{r}
# Multi-sample analysis with and without Harmony or spatial alignment
