...
ggsave("./data_outputs/visuals/Bench_singleSamples_spPlots.pdf", 
       plot = sp_plots_comb, width = 12, height = 10, units = "in")
```
...
ggsave("./data_outputs/visuals/Bench_metrics.pdf",
       plot = comb_resource_plot, width = 12, height = 4, units = "in")
```
