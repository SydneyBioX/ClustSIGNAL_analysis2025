---
title: "Fig. 2: ClustSIGNAL’s adaptive smoothing approach is robust"
...
ggsave("./data_outputs/visuals/Fig2a.pdf", plot = panel_a, unit = "in",
       width = 3, height = 10.5)
```
...
ggsave("./data_outputs/visuals/Fig2b.pdf", plot = panel_b, unit = "in",
       width = 5, height = 10)
```
...
ggsave("./data_outputs/visuals/Fig2c.pdf", plot = panel_c, unit = "in",
       width = 3.5, height = 10)
```
...
ggsave("./data_outputs/visuals/Fig2d.pdf", plot = panel_d, unit = "in",
       width = 3, height = 10)
```
...
ggsave("./data_outputs/visuals/Fig2e.pdf", plot = panel_e, unit = "in",
       width = 3, height = 10)
```
...
ggsave("./data_outputs/visuals/Fig2f.pdf", plot = panel_f, unit = "in",
       width = 3, height = 10)
```
...
ggsave("./data_outputs/visuals/Fig2g.pdf", plot = panel_g, unit = "in",
       width = 3, height = 10)
```
...
ggsave("./data_outputs/visuals/Fig2h.pdf", plot = panel_h, unit = "in",
       width = 3, height = 9.2)
```