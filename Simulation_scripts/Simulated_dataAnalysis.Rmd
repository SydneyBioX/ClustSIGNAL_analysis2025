...
saveRDS(ari_iter_df, 
        file = "./data_outputs/simDataOut/ari_smoothBench_iter20.Rds")
```
...
saveRDS(ari_dsamp_df, 
        file = "./data_outputs/simDataOut/ari_sparsityRuns_iter20.Rds")
```
...
saveRDS(ari_seg_df, 
        file = "./data_outputs/simDataOut/ari_segErrorRuns_iter20.Rds")
```
...
for (i in seq_len(nrow(initC_tests))) { # for each pattern iteration
    ...
    output_initC_df <- rbind(
        ...
        data.frame(
            ...
            ari_initC_mbkmeans = ARI(spe_louvain$initCluster,
                                     spe_mbkmeans$initCluster),
            ari_initS_mbkmeans = ARI(spe_louvain$initSubcluster,
                                     spe_mbkmeans$initSubcluster),
            ari_ClustSIGNAL_mbkmeans = ARI(spe_louvain$CellType,
                                           spe_mbkmeans$ClustSIGNAL),
            # walktrap data
            ...
            ari_initS_dbscan = ARI(spe_louvain$initSubcluster,
                                   spe_dbscan$initSubcluster),
            ari_ClustSIGNAL_dbscan = ARI(spe_louvain$CellType,
                                         spe_dbscan$ClustSIGNAL)))
    print(paste("Run", i, "complete."))
}
